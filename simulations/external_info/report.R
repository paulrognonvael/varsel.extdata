summarize.sim <- function(scenario,path){
  ...
  ggsave(paste0('p.probrecov.ex',scenario,'.pdf'),width = 52, height = 60, units='mm')
  ...
  ggsave(paste0('p.FDR.ex',scenario,'.pdf'),width = 52, height = 60, units='mm')
  ...
  ggsave(paste0('p.power.ex',scenario,'.pdf'),width = 52, height = 60, units='mm')
  ...
  ggsave(paste0('p.est.mse.ex',scenario,'.pdf'),width = 52, height = 60, units='mm')
  ...
  ggsave(paste0('p.time.ex',scenario,'.pdf'),width = 52, height = 60, units='mm')
}
